...
namespace Unity.FPS.Gameplay
{
    public class ProjectileStandard : ProjectileBase
    {
        ...
        [Tooltip("Distance over which the projectile will correct its course to fit the intended trajectory")]
        ...
        [Header("Wwise Audio")]
        [Tooltip("Wwise event to post on impact")]
        public AK.Wwise.Event ProjectileImpactEvent;
        ...
        void OnHit(Vector3 point, Vector3 normal, Collider collider)
        {
            ...
            // Wwise sound
            Wwise3DEmitter.PlayOneShotAt(ProjectileImpactEvent, point, "AudioManager", 2f);
